# -*- coding: utf-8 -*-
"""
Created on Sun Jan  7 15:21:02 2024
...
#R-squared = 1: The model perfectly predicts the target variable.

#R-squared = 0: The model performance is no better than predicting the mean of the target 
#variable.

#R-squared < 0: The model performs worse than a horizontal line representing the mean.
#This can happen when the model is poorly fitting the data.
